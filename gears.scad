...
// spur_gear (modul=1, tooth_number=30, width=5, bore=4, pressure_angle=20, helix_angle=0, optimized=true);
...
// bevel_gear_pair(modul=1, gear_teeth=30, pinion_teeth=11, axis_angle=90, tooth_width=5, bore=4, pressure_angle = 20, helix_angle=20, together_built=true);

// bevel_herringbone_gear_pair(modul=1, gear_teeth=30, pinion_teeth=11, axis_angle=90, tooth_width=5, bore=4, pressure_angle = 20, helix_angle=30, together_built=true);
